export default function Features() {
  return (
    <section id="features" className="w-full relative py-32 bg-white/60 border-t border-slate-200/50 backdrop-blur-3xl z-10">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Feature 2 */}
          <div className="group p-10 rounded-[2.5rem] bg-white border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_20px_40px_rgb(14,165,233,0.10)] hover:-translate-y-2 transition-all duration-500">
            <div className="w-16 h-16 rounded-[1.25rem] flex items-center justify-center mb-8 shadow-sm border border-sky-100 text-sky-600 bg-sky-50 group-hover:scale-110 group-hover:bg-sky-600 group-hover:text-white transition-all duration-500">
