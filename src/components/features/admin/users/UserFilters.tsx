...
export function UserFilters({ 
  ...
  return (
    <div className="px-6 py-5 border-b border-slate-200/60 flex flex-col sm:flex-row gap-4 justify-between items-center bg-white/50 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4 w-full sm:w-auto">
        ...
        <div className="relative w-full sm:w-64">
          ...
          <input
            ...
            className="form-input pl-9 py-2 text-sm bg-white/70 hover:bg-white transition-colors border-slate-200"
          />
        </div>
      </div>
    </div>
