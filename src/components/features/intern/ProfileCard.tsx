...
export function ProfileCard({ intern, departmentName }: ProfileCardProps) {
  return (
    <div className="card-glass bg-white/50 p-8 flex flex-col items-center justify-center text-center shadow-sm">
      <div className="w-32 h-32 rounded-[2rem] bg-gradient-to-br from-indigo-100 to-pink-100 shadow-inner flex items-center justify-center mb-6 relative group overflow-hidden border-4 border-white/60">
        <span className="text-5xl font-black text-indigo-400/50">{intern.name.charAt(0).toUpperCase()}</span>
      ...
      <p className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-indigo-50 text-indigo-700 uppercase tracking-wider mb-4 border border-indigo-100">
